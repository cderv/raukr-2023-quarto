...
-   Quarto is RStudio's attempt to bring 10-years experience of R Markdown to everyone!
...
| [RStudio Connect](https://quarto.org/docs/publishing/rstudio-connect.html) | Publishing platform for secure sharing of data products within an organization.                                      |
...
-   Example: <https://quarto.org> and more at <https://quarto.org/docs/gallery/#websites>
...
-   Examples: <https://quarto.org/docs/blog/> and more at <https://quarto.org/docs/gallery/#websites>
...
#### Slides: <https://jjallaire.quarto.pub/rmedicine-introduction-to-quarto> {.bottom-pad}
